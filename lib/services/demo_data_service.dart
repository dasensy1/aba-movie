  ...
  List<Movie> get demoMovies {
    return [
      Movie(
        id: 1,
        title: 'Начало',
        overview: 'Кобб — талантливый вор, лучший в опасном искусстве извлечения секретов из подсознания во время сна.',
      ...
      Movie(
        id: 2,
        title: 'Интерстеллар',
        overview: 'Когда засуха и пыльные бури приводят человечество к продовольственному кризису, бывший пилот НАСА Купер отправляется в экспедицию через червоточину.',
        posterPath: '/pbr1LiyL6L9gX8Y9gX8Y9gX8Y9.jpg',
